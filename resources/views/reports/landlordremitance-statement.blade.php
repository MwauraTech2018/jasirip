        ...
        <div class="row">
                <div class="col-md-11 col-md-offset-1">
                    <div class="form-group" id="date-range-div" >
                        <form action="{{ url('getLanlordRemmitanceStatement') }}" id="plot-form" method="post">
                            {{ csrf_field() }}
                            <div class="col-md-3">
                                <label>Status</label>
        ...
        <div class="row">
            <div class="col-md-12 table-responsive">
                <table class="table table-striped">
                    ...
                    <tr><td><strong>Lanlord Name:</strong></td><td><strong>{{(is_null($landlords2))?"All Lanlords":$landlords2->full_name}}</strong></td></tr>
